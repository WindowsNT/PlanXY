...
namespace winrt::WuiFET::implementation
{
    struct Resizer : ResizerT<Resizer>
    {
        ...
        WuiFET::SplitOrientation Orientation() const;
        void Orientation(WuiFET::SplitOrientation const& value);
        ...
        // Events
        winrt::event_token ValueChanged(Windows::Foundation::TypedEventHandler<WuiFET::Resizer, Windows::Foundation::IInspectable> const& handler);
        ...
        winrt::event<Windows::Foundation::TypedEventHandler<WuiFET::Resizer, Windows::Foundation::IInspectable>> m_valueChangedEvent;
