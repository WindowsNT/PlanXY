...
{
	std::string x1; // e.g. Maximum_Hours_Continuously, Minimum_Days_Per_Week
	std::wstring d1; // display name
	int type = 0; // 0 number,1 bool, 2 single list, 3 multiple list
 	int from = 0;
	int def = 0; // and value
	int to = 1;
...
public:
	...
	int SubType = 0; // 0 All, 1 Teacher 2 Class 3 Room 4 Subject
