...
namespace winrt::WuiFET::implementation
{
    struct DGCellModel : DGCellModelT<DGCellModel>
    {
        ...
        void ValueB(bool v)
        {
            ...
            if ((_whatx == 1 || _whatx == 2 || _whatx == 3 || _whatx == 4 || _whatx == 5 || _whatx == 6 || _whatx == 7 || _whatx == 8 || _whatx == 15 || _whatx == 16) && _ptr2 && _ptr3)
            {
                // pi1 = DGDataGrid
                // pi2 = MainWindow
                // Ptr2 = root
                ...
                std::string search_1 = (_whatx == 6 || _whatx == 16) ? "Preferred_Time_Slot" : (_whatx == 5  || _whatx == 15) ? "Preferred_Starting_Time" : "Not_Available_Time";
				std::string search_2 = (_whatx == 6 || _whatx == 16) ? "Number_of_Preferred_Time_Slots" : (_whatx == 5 || _whatx == 15) ? "Number_of_Preferred_Starting_Times" : "Number_of_Not_Available_Times";
                ...
                if (!_ptr)
                {
                    ...
                    if (!ConstraintTeacherNotAvailableTimes)
                    {
                        ...
                        if (_whatx == 5 || _whatx == 6 || _whatx == 15 || _whatx == 16)
